    ...
    template: `
        <div class="header__links__left--search">
            <form action="#" method="post" @submit.prevent="$root.$refs.products.filter(userSearch)">
                <input type="text" class="header__links__left--search-field" placeholder="Ищем книги" v-model="userSearch">
                    <button type="submit">
        ...
        <nav class="nav" v-show="$parent.showMenu">
            <div class="nav__container">
                ...
                <ul class="nav__container__parent">
                    <li class="nav__container__parent--li">Мужчинам</li>
                    ...
                    <li class="nav__container__parent--li">Женщинам</li>
                        <ul class="nav__container__child">
                    ...
                    <li class="nav__container__parent--li">Детям</li>
                        <ul class="nav__container__child">
                            <li><a href="#">Манга</a></li>
                            <li><a href="#">Комиксы</a></li>
                            <li><a href="#">Энциклопедии</a></li>
                            <li><a href="#">Школьные предметы</a></li>
                            <li><a href="#">Программирование для самых маленьких</a></li>
                        </ul>
                </ul>
            </div>
