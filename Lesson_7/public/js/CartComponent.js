    ...
    <h2 v-if=" cartItems.length === 0">Корзина пуста</h2>
        <div v-else >
            ...
            <div class="cart-block" v-show="showCart">      
                <h3 > ИТОГО: {{ this.cartItems.reduce((summ, item) => summ + item.quantity*item.price, 0) }} рублей за {{ this.cartItems.reduce((summ, item) => summ + item.quantity, 0) }} товар(ров).</h2>
...
Vue.component('cart-item', {
    ...
    <div class="cart-item">
        ...
        <div class="product-desc">
            ...
            <p>Цена: {{ cartItem.price }} рублей за 1 книгу.</p>
            ...
            <p>Сумма: {{ cartItem.price * cartItem.quantity }} рублей.</p>
        </div>
    </div>
    `
})